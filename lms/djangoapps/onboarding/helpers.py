...
from common.djangoapps.util.lib.hubspot_client.handlers import update_user_email_in_hubspot
...
def update_user_email(user, old_email, new_email):
    ...
    context = {
        'emailId': Mandril.CHANGE_USER_EMAIL_ALERT,
        'message': {
            'to': None,
        },
        'customProperties': {
