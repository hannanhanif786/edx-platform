...
from common.djangoapps.util.lib.tasks import task_send_hubspot_email
...
from common.djangoapps.student.models.user import Registration
...
def send_account_activation_email(request, registration, user):
    ...
    task_send_hubspot_email.delay(data)
...
def get_course_next_classes(request, course):
    ...
    for _course in courses:
        ...
        if request.user.is_authenticated() and request.user.is_staff:
            ...
            from lms.djangoapps.philu_overrides.timed_notification import get_course_first_chapter_link
